...
class Upma(Scene):
    def construct(self):
        ...
        anupras=Text("उत्प्रेक्षा अलंकार ",font="Nirmala UI").move_to(UP*3)
        ...
        defination="""जब समानता होने के कारण उपमेय में उपमान के होने कि कल्पना की जाए या संभावना हो तब वहां उत्प्रेक्षा अलंकार होता है। """
        ...
        example=MarkupText(f'नेत्र मानो कमल हैं। ',line_spacing=1,font_size=25,font="Nirmala UI").next_to(udahran,DOWN*2)
